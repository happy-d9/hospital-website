      ...
      <div id="navbar" data-aos="fade-down">
        <div className="container">
          ...
          <section className="content container">
            <h5 className='text-center'>All Doctor</h5>
                          ...
                          <div className="card xl-khaki member-card doctor">
                            <div className="body">
                              <div className="member-thumb">
                                <img
                                  src={require("../assets/images/doctors/member2.png")}
                                  className="img-fluid"
                                  alt="profile-image"
                                />
                              </div>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6">
                          <div className="card xl-blue member-card doctor">
                            <div className="body">
                              <div className="member-thumb">
                                <img
                                  src={require("../assets/images/doctors/member3.png")}
                                  className="img-fluid"
                                  alt="profile-image"
                                />
                              </div>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6">
                          <div className="card xl-pink member-card doctor">
                            <div className="body">
                              <div className="member-thumb">
                                <img
                                  src={require("../assets/images/doctors/member5.png")}
                                  className="img-fluid"
                                  alt="profile-image"
                                />
                              </div>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6">
                          <div className="card xl-seagreen member-card doctor">
                            <div className="body">
                              <div className="member-thumb">
                                <img
                                  src={require("../assets/images/doctors/member6.png")}
                                  className="img-fluid"
                                  alt="profile-image"
                                />
                              </div>
