...
function pricelist()
{
    return(
<>
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/price-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:46 GMT */}
          ...
          <div className="row">
            <div className="col-lg-4 col-md-12">
              <div className="card text-center">
                ...
                <div className="price xl-turquoise">
                  <h3>
                    $ 99 / <span>year</span>
                  </h3>
                </div>
                <div className="body">
                  <ul className="list-unstyled">
                    <li>
                      <strong>Internal</strong> Medicine Consultation
                    </li>
                    <li>
                      Internal <strong>Medicine</strong> Review
                    </li>
                    <li>
                      <strong>Blood</strong> Sugar Fasting
                    </li>
                    <li>
                      <strong>Blood</strong> Grouping and RH Factor
                    </li>
                    <li>Creatinine, Serum</li>
                  </ul>
                  <button
                    className="btn btn-default btn-simple btn-round btn-lg"
                    data-aos="flip-up"
                  >
                    Get this plan
                  </button>
            ...
            <div className="col-lg-4 col-md-12">
              <div className="card text-center">
                <h5>KIDS PACKAGE</h5>
                <p>Just need initial support</p>
                <div className="price xl-slategray">
                  <h3>
                    $ 99 / <span>year</span>
                  </h3>
                </div>
