  ...
  <div className="wrapper">
    ...
    <section id="hero">
      <div
        ...
        <img src={require("./assets/images/banner-contactus.jpg")} style={{maxHeight:'300px',height: '300px',position:'relative',backgroundSize:'cover',backgroundPosition:'center center'}}></img>
        <div className="container">
          <h3 className="title">
            Oreo <br />
            <big>
